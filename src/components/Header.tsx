...
import avatarImage from '@/images/jason.png'
...
function ThemeToggle() {
  ...
  return (
    ...
    >
      ...
      <MoonIcon className="hidden h-6 w-6 fill-zinc-700 stroke-zinc-500 transition not-[@media_(prefers-color-scheme:dark)]:fill-indigo-400/10 not-[@media_(prefers-color-scheme:dark)]:stroke-indigo-500 dark:block [@media(prefers-color-scheme:dark)]:group-hover:stroke-zinc-400" />
    </button>
  )
}
...
export function Header() {
  return (
    ...
    >
      <div
        className="sticky top-0 z-10 h-16 pt-6"
      >
        <Container>
